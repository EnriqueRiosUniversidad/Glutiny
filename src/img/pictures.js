...
export { default as tiendas } from './tiendas.png';
export { default as restaurantes } from './restaurantes.png';
export { default as recetas } from './recetas.png';
export { default as maps } from './maps.png';

//Tiendas
export { default as super6 } from './super6.png';
export { default as super_familia } from './super_familia.png';
export { default as Super_sanMartin } from './Super_sanMartin.png';
export { default as cityMarket } from './cityMarket.png';
...
//Recetas
export { default as imagen1 } from './imagenReceta/imagen1.PNG';
export { default as imagen2 } from './imagenReceta/imagen2.PNG';
export { default as imagen3 } from './imagenReceta/imagen3.PNG';
export { default as imagen4 } from './imagenReceta/imagen4.PNG';
export { default as imagen5 } from './imagenReceta/imagen5.PNG';
export { default as imagen6 } from './imagenReceta/imagen6.PNG';
export { default as imagen7 } from './imagenReceta/imagen7.PNG';
export { default as imagen8 } from './imagenReceta/imagen8.PNG';
export { default as imagen9 } from './imagenReceta/imagen9.PNG';

export { default as logoReceta } from './logo-recetas.png';
